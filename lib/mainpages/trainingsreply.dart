...
class TrainingReplyPage extends StatefulWidget {
  String? title;
  String? desc;
  String? tile;
  String? tid;
  ...
  @override
  State<TrainingReplyPage> createState() => _TrainingReplyPageState();
}
...
class _TrainingReplyPageState extends State<TrainingReplyPage> {
  @override
  void initState() {
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          viewreply!.trainningAndNoteReplies == null
                              ? Container(
                                  height: 70.h,
                              ...
                              : SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: viewreply!
                                        .trainningAndNoteReplies!.length,
                                  ),
                                ),
                          SizedBox(
                            height: 7.h,
  ...
  addreply() {
    if (_reply.text == '') {
      ...
      data['action'] = 'sent_replies_trainings_app';
      ...
      checkInternet().then((internet) async {
        if (internet) {
          authprovider().replyapi(data).then((Response response) async {
  ...
  viewallreply() {
    final Map<String, String> data = {};
    data['action'] = 'replies_trainings_app';
    data['player_id'] = userData!.userData!.uid.toString();
    data['tr_n_notes_id'] = widget.tid.toString();

    checkInternet().then((internet) async {
      if (internet) {
        authprovider().viewreplyapi(data).then((Response response) async {
          viewreply = ReplyModal.fromJson(json.decode(response.body));
