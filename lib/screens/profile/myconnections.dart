...
class _MyConnectionsState extends State<MyConnections> {
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Container(
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: CachedNetworkImage(
                                                  fit: BoxFit.cover,
                                                  imageUrl: connections?.connectedUsers?[index].profilePic ?? '',
                                            ...
                                            Text(
                                             connections?.connectedUsers?[index].name ?? '',
                                              maxLines: 2,
  ...
  TextStyle textStyle = TextStyle(
      color: Colors.grey.shade500, fontSize: 12.sp, fontFamily: 'Meta1');TextStyle textStyle1 = TextStyle(
