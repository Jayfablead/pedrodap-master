                    ...
                    children: [
                      ...
                      Container(alignment: Alignment.center,
                        ...
                        child: ListView.builder(
                          itemCount: allchats?.messagesData?.length,
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          CachedNetworkImage(
                                            fit: BoxFit.cover,
                                            imageUrl: allchats?.messagesData?[index].profilePic ?? '',
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  allchats?.messagesData?[index].name ?? '',
                                                  style: TextStyle(
                                                      fontSize: 16.sp,
                                                ...
                                                Text(
                                                  allchats?.messagesData?[index].time ?? '',
                                                  style: TextStyle(
                                                      fontSize: 10.sp,
                                          ...
                                          SizedBox(
                                            width: 52.w,
                                            child: Text(
                                              allchats?.messagesData?[index].message ?? '',
                                              maxLines: 2,
                                              style: TextStyle(
                                                  fontSize: 10.sp,
                                                  fontWeight: FontWeight.w400,
