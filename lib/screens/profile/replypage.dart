...
class _ReplyPageState extends State<ReplyPage> {
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          fitviewreply!.fitnessProgrammeReplies == null
                              ? Container(
                                  height: 70.h,
                              ...
                              : SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: fitviewreply!
                                        .fitnessProgrammeReplies!.length,
                                  ),
                                ),
                          SizedBox(
                            height: 7.h,
  ...
  addreply() {
    if (_reply.text == '') {
      ...
      data['action'] = 'sent_replies_fitness_programme_app';
      ...
      checkInternet().then((internet) async {
        if (internet) {
          authprovider().fitviewreplyapi(data).then((Response response) async {
            fitviewreply = FitreplyModal.fromJson(json.decode(response.body));
  ...
  viewallreply() {
    final Map<String, String> data = {};
    data['action'] = 'replies_fitness_programme_app';
    data['player_id'] = userData!.userData!.uid.toString();
    data['fitness_programme_id'] = widget.tid.toString();
