...
class CreateScouts extends StatefulWidget {
  const CreateScouts({Key? key}) : super(key: key);

  @override
  State<CreateScouts> createState() => _CreateScoutsState();
}
...
class _CreateScoutsState extends State<CreateScouts> {
  @override
