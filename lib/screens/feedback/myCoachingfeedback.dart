...
import 'package:pedrodap/screens/viewmysessionpages/viewmycoach.dart';
import 'package:sizer/sizer.dart';

import '../../Widget/Drawer.dart';

class MyCoachingFeedbackPage extends StatefulWidget {
  const MyCoachingFeedbackPage({Key? key}) : super(key: key);

  @override
  State<MyCoachingFeedbackPage> createState() => _MyCoachingFeedbackPageState();
}
...
class _MyCoachingFeedbackPageState extends State<MyCoachingFeedbackPage> {
  @override
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (context) => ViewMyCoaching(),
                                    ),
                                  );
                                },
                                child: Container(
