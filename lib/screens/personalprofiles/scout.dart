...
import 'package:pedrodap/screens/editpersonalprofiles/editscout.dart';
...
class PersonalScout extends StatefulWidget {
  ...
  @override
  State<PersonalScout> createState() => _PersonalScoutState();
}
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text(
                "Professional Scouting Trainer Helps Players To Do Adventurous Activities. ",
                style: TextStyle(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => editScoutpersonalprofile(
