...
import '../editpersonalprofiles/edittrainer.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text(
                "Professional Football Trainer Who Trains Players For Dribling,Running,Shooting,Etc more. ",
                style: TextStyle(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => editTrainerpersonalprofile(
