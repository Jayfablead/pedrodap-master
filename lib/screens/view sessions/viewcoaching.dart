...
class ViewCoaching extends StatefulWidget {
  const ViewCoaching({Key? key}) : super(key: key);

  @override
  State<ViewCoaching> createState() => _ViewCoachingState();
}
...
class _ViewCoachingState extends State<ViewCoaching> {
  @override
