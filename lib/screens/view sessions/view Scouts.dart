...
class ViewScouts extends StatefulWidget {
  const ViewScouts({Key? key}) : super(key: key);

  @override
  State<ViewScouts> createState() => _ViewScoutsState();
}
...
class _ViewScoutsState extends State<ViewScouts> {
  @override
