...
class CreateMedical extends StatefulWidget {
  const CreateMedical({Key? key}) : super(key: key);

  @override
  State<CreateMedical> createState() => _CreateMedicalState();
}
...
class _CreateMedicalState extends State<CreateMedical> {
  @override
