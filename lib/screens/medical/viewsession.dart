...
class ViewMedical extends StatefulWidget {
  const ViewMedical({Key? key}) : super(key: key);

  @override
  State<ViewMedical> createState() => _ViewMedicalState();
}
...
class _ViewMedicalState extends State<ViewMedical> {
  @override
