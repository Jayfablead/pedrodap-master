...
class MyMedicalFeedbackPage extends StatefulWidget {
  const MyMedicalFeedbackPage({Key? key}) : super(key: key);

  @override
  State<MyMedicalFeedbackPage> createState() =>
      _MyMedicalFeedbackPageState();
}
...
class _MyMedicalFeedbackPageState extends State<MyMedicalFeedbackPage> {
  @override
