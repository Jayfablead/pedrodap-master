...
class NutriListing extends StatefulWidget {
  const NutriListing({Key? key}) : super(key: key);

  @override
  State<NutriListing> createState() => _NutriListingState();
}
...
List<Sachen> profile = [
  Sachen(
      "01-02-2023", "Dietitians ", "Left West High Postion training", '45 Mins'),
  Sachen("03-02-2023", "Deit Plans", "Goal kipping Practice", '30 Mins'),
  Sachen("05-02-2023", "Eating Habits", "Teaching penalty Shootout", '60 Mins'),
  Sachen("08-02-2023", "Manage Disease", "Teach Driblling Fast", '30 Mins'),
  Sachen("10-02-2023" ,"Health", "Left West High Postion training", '45 Mins'),
];

class _NutriListingState extends State<NutriListing> {
  @override
