...
import 'package:pedrodap/screens/all%20profiles/nutritionistprofile.dart';
...
import 'package:pedrodap/screens/personalprofiles/nutritionist.dart';
...
class MyNutritionistProfile extends StatefulWidget {
  const MyNutritionistProfile({Key? key}) : super(key: key);

  @override
  State<MyNutritionistProfile> createState() => _MyNutritionistProfileState();
}
...
class _MyNutritionistProfileState extends State<MyNutritionistProfile> {
  @override
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      ...
                      CircleAvatar(
                        ...
                        child: CircleAvatar(
                          ...
                          radius: 5.7.h,
                          child: CircleAvatar(
                            backgroundImage: AssetImage('assets/tainer.jpg'),
                            radius: 7.h,
                          ),
                        ),
                      ),
                  ...
                  Text(
                    'nutritionist.trainer@gmail.com',
                    style: TextStyle(
                      fontSize: 4.5.w,
                      fontWeight: FontWeight.w500,
                      fontFamily: "Poppins",
                  ...
                  InkWell(onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => PersonalNutritionist(),
                      ),
                    );
                  },
                    child: Container(
