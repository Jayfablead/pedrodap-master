...
class editScoutpersonalprofile extends StatefulWidget {
  String? name;
  String? email;
  String? phone;
  String? exp;
  ...
  @override
  State<editScoutpersonalprofile> createState() =>
      _editScoutpersonalprofileState();
}
...
class _editScoutpersonalprofileState
    extends State<editScoutpersonalprofile> {
  @override
  void initState() {
    super.initState();
