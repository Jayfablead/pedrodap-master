...
class editmedicalpersonalprofile extends StatefulWidget {
  String? name;
  String? email;
  String? phone;
  String? exp;
  ...
  @override
  State<editmedicalpersonalprofile> createState() =>
      _editmedicalpersonalprofileState();
}
...
class _editmedicalpersonalprofileState
    extends State<editmedicalpersonalprofile> {
  @override
  void initState() {
    super.initState();
