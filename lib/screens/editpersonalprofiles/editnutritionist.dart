...
class editNutritionistpersonalprofile extends StatefulWidget {
  String? name;
  String? email;
  String? phone;
  String? exp;
  ...
  editNutritionistpersonalprofile(
      {Key? key,
      this.name,
      this.about,
      this.email,
  ...
  @override
  State<editNutritionistpersonalprofile> createState() =>
      _editNutritionistpersonalprofileState();
}
...
class _editNutritionistpersonalprofileState
    extends State<editNutritionistpersonalprofile> {
  @override
  void initState() {
    super.initState();
