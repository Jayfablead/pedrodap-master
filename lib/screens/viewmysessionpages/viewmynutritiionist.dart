...
class ViewMyNutritionist extends StatefulWidget {
  const ViewMyNutritionist({Key? key}) : super(key: key);

  @override
  State<ViewMyNutritionist> createState() => _ViewMyNutritionistState();
}
...
class _ViewMyNutritionistState extends State<ViewMyNutritionist> {
  @override
