...
class ViewMyTraining extends StatefulWidget {
  const ViewMyTraining({Key? key}) : super(key: key);

  @override
  State<ViewMyTraining> createState() => _ViewMyTrainingState();
}
...
class _ViewMyTrainingState extends State<ViewMyTraining> {
  @override
