...
class ViewMyCoaching extends StatefulWidget {
  const ViewMyCoaching({Key? key}) : super(key: key);

  @override
  State<ViewMyCoaching> createState() => _ViewMyCoachingState();
}
...
class _ViewMyCoachingState extends State<ViewMyCoaching> {
  @override
